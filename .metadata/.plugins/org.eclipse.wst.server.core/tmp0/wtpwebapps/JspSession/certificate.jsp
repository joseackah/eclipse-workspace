...
<div style="text-align:center; border: 1.2em solid black; width: 60%; position: absolute; left: 20%; top: 20%;">
...
<h1> BERNICE'S INTERNATIONAL PREPARATORY SCHOOL</h1>
 ...
 <div style=""> <p style="margin-left: 18em;"> July, 2021</p></div>
  </div>
  <div style="display: flex; position: relative; left:25%;"> <div style="width: 20%; "> <hr> </div> <div> <p style="position: relative; bottom:35%; margin: 2em 2em;"> day of </p></div><div style="width: 20%;"> <hr> </div></div>
  <p style="margin-top: -1em; margin-bottom: 2em;"> having been admitted to Diploma in Nursing</p>
  
  <p style="position: relative; left:10%; margin-bottom:-0.5em; font-weight:bold; font-size: 1.3em;">First Class (Honour Division)</p>
