...
<body>
 <div id='firstHeader' class='firstHeader' name='firstHeader'>
    ...
    <nav> 
        <ul>
        <li><a href="${pageContext.request.contextPath}/general/homeExample">HOME Example</a></li>
...
<form action="${pageContext.request.contextPath}/general/validate"  method="post">
		<table class="form">
			<tr>
				<td><label>Admin Id : </label></td> 
				<td><input style="border-radius: 3em; margin-bottom: 1em; height:3.5em; width: 120%" type="text" placeholder="Id" value="" name="admin" /></td>
			</tr>
			<tr>
				<td><label>Password : </label></td>
				<td><input style="border-radius: 3em; height: 3.5em; width: 120%;" type="text"  placeholder="Password" value=""  name="password" /></td>
			</tr>
