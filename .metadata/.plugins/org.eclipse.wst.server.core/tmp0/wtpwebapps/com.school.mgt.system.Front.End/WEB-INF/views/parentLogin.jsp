...
<div id='firstHeader' class='firstHeader' name='firstHeader'>
	...
	<div class="wrapper">
		...
		<form action="validate" method="post" id="main_form"
			class="main_form">
			<div class="form">
				Teacher Id: <input type="text" name="username" placeholder="Teacher Id" />
			</div>
			<div class="form">
		...
		<div id="sub">
			<a
				href="${pageContext.request.contextPath}/general/parentLogin">
				<input type="submit" value="clear">
			</a> <a href="${pageContext.request.contextPath}/general/homePage">
