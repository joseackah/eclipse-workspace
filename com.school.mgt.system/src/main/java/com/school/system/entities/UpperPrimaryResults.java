...
@Entity
@Table(name="upper_primary_results")
public class UpperPrimaryResults {
	...
	public UpperPrimaryResults() {
		
	}

	public UpperPrimaryResults(Integer results_id, Integer student_id, String first_name, String last_name,
	...
	public String toString() {
		return "UpperPrimaryResults [results_id=" + results_id + ", student_id=" + student_id + ", first_name="
