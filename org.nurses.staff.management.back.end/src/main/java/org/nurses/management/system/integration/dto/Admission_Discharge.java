...
public class Admission_Discharge {
	...
	public Admission_Discharge(Integer id, String ward_name, String patient_number, String patient_name, String sex,
			Date date_admitted, String address, String diagnosis, String phone_number, String outcome_of_admission,
			String final_diagnosis, String next_of_kin, String next_of_kin_number, String insured,
			Integer insurance_number, Date date_discharge, Integer age) {
		super();
	...
	public String toString() {
		return "Admission_Discharge [id=" + id + ", ward_name=" + ward_name + ", patient_number=" + patient_number
				+ ", patient_name=" + patient_name + ", sex=" + sex + ", age=" + age + ", date_admitted="
