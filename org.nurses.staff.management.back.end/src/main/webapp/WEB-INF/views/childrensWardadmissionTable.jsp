...
<div class="mt-3" style="text-align: center; width: 100%; margin-top:12px 0 2em;">
 <h1 >Children's Ward  </h1>
 <h2> Admission Table</h2>
    </div>
    <hr style="width:90%; margin:auto;" class="">
    <div class="container mt-3" style=" with:100%;" id="print">
