...
<aside class=" w3-marg w3-teal w3-padding w3-border w3-card w3-round-large" style="width: 20%; height:1000px;">
...
<div id="s1" style=" display:flex; flex-direction:row-reverse;"> <input class="form-control" id="myInput" type="text" placeholder="Search.." style="padding: .5em 2em; border-radius: 5em; width:20%; display:flex; flex-direction: flex-end;"> 
...
<select class  ="form-control" name="state" id="maxRows" style="width:20%; padding: .5em 2em; border-radius: 5em; display:flex; flex-direction: flex-end;">
        ...
        <table class="table table-bordered table-hover" style="background-color: aliceblue; width:auto" id="name">
            ...
            <c:url value="updateLeave1/${leave.id}"  var="update">
                ...
                <tr>
                    ...
                    <a id="action" href="${delete}" onclick="if (!confirm('Are you sure you want to delete this record?')) return false"> <i style="margin-right: 10px;" class="fa fa-trash" id="action2"></i></a>|
                    <a id="action" href="${update}"> <i class="fa fa-pen" id="action3" > </i></a>
