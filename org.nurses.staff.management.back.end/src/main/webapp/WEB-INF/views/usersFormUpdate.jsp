	...
	<div class="mo fad" id="modal-id">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form
					action="${pageContext.request.contextPath}/userFront/usersUpdate">
					<div class="modal-body">
							...
							<div class="col">
								<div class="form-group">
									<label for="name">Name</label> <input type="text"
										class="form-control" value="${users.name }" name="name" id="">
								</div>
							</div>
							<div class="col">
								<div class="form-group">
									<label for="userId">User Id</label> <input type="text"
										class="form-control" value="${users.userId }" name="userId"
										id="">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col">
								<div class="form-group">
									<label for="userType">User Type</label> <input type="text"
										class="form-control" value="${users.userType }" name="userType"
										id="">
							...
							<div class="col">
								<div class="form-group">
									<label for="ward_name">Department</label> <input type="text"
										class="form-control" value="${users.ward_name }"
										name="ward_name" id="">
								</div>
							</div>
						</div>
							...
							<div class="col">
								<div class="form-group">
									<label for="image">Image</label> <input type="file"
										class="form-control" name="image" id="" disabled>
								</div>
							</div>
						</div>
							...
							<div class="col">
								<div class="form-group">
									<label for="dateCreated">Date Created</label> <input
										type="date" class="form-control" value="${users.dateCreated }"
										name="dateCreated" id="">
								</div>
							</div>
							...
							<div class="col">
								<div class="form-group">
									<label for="createdBy">Created By</label> <input type="text"
										class="form-control" value="${users.createdBy }"
										name="createdBy" id="">
