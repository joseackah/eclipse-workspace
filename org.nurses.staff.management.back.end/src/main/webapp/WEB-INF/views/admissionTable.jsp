...
<div class="w3-bar w3-red" id="navbar_top">
    ...
    <aside class=" w3-margi w3-teal w3-paddi w3-border w3-card w3-round-large" style="width: 15%; height:1000px;">
...
<hr class="d-sm">
    ...
    <main style="width: 100%; margin-left:;">


<div style="text-align: center; width: 100%; margin:2px 0 2em;">
 
 <h1>Admission and Discharge Table</h1>
    </div>    
    <hr style="width:90%; margin: auto;">
    <div class="container mt-3" style="margin-left:0.3%; with:auto;" id="print">
