				...
				<div class="row w3-padding " style="width:200%;">
						...
						<table width="200">
							...
							<tbody id="tbe">
								...
								try {
									...
									.prepareStatement("select nurse_cate, count(*) as number from ward_schedule where ward_name = 'Female Surgical' group by nurse_cate;");
					...
					<div class="w3-card-2 w3-red w3-margin"
						...
						<p style="text-align: left;">total Admission:
							${countFemaleSurgicalAdmissionToDate}</p>
						<p style="text-align: left;">total Discharge:
							${countFemaleSurgicalDischarge}</p>
						<p style="text-align: left;">total Death: ${countFemaleSurgicalDeath}</p>
					</div>
					<div class="w3-card-2 w3-teal w3-margin"
						...
						<p style="text-align: left;">Total Admission:
							${countFemaleSurgicalTodayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countFemaleSurgicalTodayDischarge}</p>
						<p style="text-align: left;">Total Death: ${countFemaleSurgicalTodayDeath}</p>
					</div>
					...
					<div class="w3-card-2 w3-teal w3-margin w3-round-large"
						...
						<p style="text-align: left;">Total Admission:
							${countFemaleSurgicalYesterdayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countFemaleSurgicalYesterdayDischarge}</p>
						<p style="text-align: left;">Total Death:
							${countFemaleSurgicalYesterdayDeath}</p>
	...
	<script type="text/javascript">
		...
		function drawChart() {
			var data = google.visualization.arrayToDataTable([
					...
					[ 'Year', 'Admission', 'Discharge', 'Death' ],
					/* [0, 0, 0, 0], */
					[ 'Jan', ${countFemaleSurgicalAdmissionJanuary}, ${countFemaleSurgicalDischargeJanuary}, ${countFemaleSurgicalDeathJanuary}], 
					[ 'Feb', ${countFemaleSurgicalAdmissionFebruary}, ${countFemaleSurgicalDischargeFebruary}, ${countFemaleSurgicalDeathFebruary} ],
					[ 'March', ${countFemaleSurgicalAdmissionMarch}, ${countFemaleSurgicalDischargeMarch}, ${countFemaleSurgicalDeathMarch} ], 
					[ 'April', ${countFemaleSurgicalAdmissionApril}, ${countFemaleSurgicalDischargeApril}, ${countFemaleSurgicalDeathApril} ],
					[ 'May', ${countFemaleSurgicalAdmissionMay}, ${countFemaleSurgicalDischargeMay}, ${countFemaleSurgicalDeathMay} ],
					[ 'June', ${countFemaleSurgicalAdmissionJune}, ${countFemaleSurgicalDischargeJune}, ${countFemaleSurgicalDeathJune} ],
					[ 'July', ${countFemaleSurgicalAdmissionJuly}, ${countFemaleSurgicalDischargeJuly}, ${countFemaleSurgicalDeathJuly} ],
					[ 'Aug', ${countFemaleSurgicalAdmissionAugust}, ${countFemaleSurgicalDischargeAugust}, ${countFemaleSurgicalDeathAugust} ],
					[ 'Sept', ${countFemaleSurgicalAdmissionSeptember}, ${countFemaleSurgicalDischargeSeptember}, ${countFemaleSurgicalDeathSeptember} ],
					[ 'Oct', ${countFemaleSurgicalAdmissionOctober}, ${countFemaleSurgicalDischargeOctober}, ${countFemaleSurgicalDeathOctober} ],
					[ 'Nov', ${countFemaleSurgicalAdmissionNovember}, ${countFemaleSurgicalDischargeNovember}, ${countFemaleSurgicalDeathNovember} ],
					[ 'Dec', ${countFemaleSurgicalAdmissionDecember}, ${countFemaleSurgicalDischargeDecember}, ${countFemaleSurgicalDeathDecember} ]
