...
<div class="row">
								<div class="col">
									<div class="form-group">
										...
										<input type="text" name="ward_name" class="form-control" value="${leave.ward_name }" >
									</div>
                                ...
                                <div class="col">
                                 ...
                                 <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="incharge_recom" class="form-control" value="${leave.incharge_recom}" readonly>
...
<div class="row">
                                <div class="col">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="incharge_name" value="${leave.incharge_name}" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="resumption_date" id="">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="approved_by" id="">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="date_approved">Date Approved</label>
                                        <input type="date" class="form-control" name="date_approved" id="">
                                    </div>
                                </div>
                            </div>
