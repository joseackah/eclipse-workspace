...
<div class="class mt-3" style="text-align: center; width: 100%; margin-top:12px 0 2em;">
 ...
 <h2>Outpatient Leave Recommendation Table</h2>
    </div>    
    <hr style="width:90%">
    ...
    <!-- <div style="text-align: center; width: 100%;"> -->
       ...
       <!-- <hr>  -->
       <div> </div> <br> <br>
        <button id="b1" style="float: left; border-radius: 5em; " class="btn btn-primary" onclick="window.location.href='${pageContext.request.contextPath}/generalFront/opd'">back</button>
