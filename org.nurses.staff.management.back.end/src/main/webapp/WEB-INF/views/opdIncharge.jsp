...
<title>Outpatient Department Home</title>
<meta charset="utf-8">
				...
				<div class="w3-container w3-padding w3-center"
					...
					<div class="row w3-padding " style="width: 200%;">
						...
						<div class="w3-card-2 w3-yellow w3-margin"
							...
							<p style="text-align: left;">total Nurses: ${nurseInOpd}</p>
							...
							<table width="200">
								...
								<tbody id="tbe">
									...
									try {
										...
										"select nurse_cate, count(*) as number from ward_schedule where ward_name = 'Outpatient Department' group by nurse_cate;");
						...
						<div class="w3-card-2 w3-red w3-margin"
							...
							<p style="text-align: left;">total Admission:
								${countOpdAdmissionToDate}</p>
							<p style="text-align: left;">total Discharge:
								${countOpdDischarge}</p>
							<p style="text-align: left;">total Death: ${countOpdDeath}</p>
						</div>
						<div class="w3-card-2 w3-teal w3-margin"
							...
							<p style="text-align: left;">Total Admission:
								${countOpdTodayAdmission}</p>
							<p style="text-align: left;">Total Discharge:
								${countOpdTodayDischarge}</p>
							<p style="text-align: left;">Total Death:
								${countOpdTodayDeath}</p>
						</div>
							...
							<a class="w3-card-2 w3-blue w3-margin" style="" href="#"> <strong>
								...
								<table>
									...
									try {
										...
										.prepareStatement("select bed_capacity from ward where ward_name = 'Outpatient Department';");
									...
									try {
										...
										"select count(*) as a from admission_discharge where year(date_admitted) = year(curdate())  and ward_name = 'Outpatient Department' and outcome_of_admission is null or outcome_of_admission='';");
						...
						<div class="w3-card-2 w3-teal w3-margin w3-round-large"
							...
							<p style="text-align: left;">Total Admission:
								${countOpdYesterdayAdmission}</p>
							<p style="text-align: left;">Total Discharge:
								${countOpdYesterdayDischarge}</p>
							<p style="text-align: left;">Total Death:
								${countOpdYesterdayDeath}</p>
	...
	<script type="text/javascript">
		...
		function drawChart() {
			var data = google.visualization.arrayToDataTable([
					...
					[ 'Year', 'Admission', 'Discharge', 'Death' ],
					/* [0, 0, 0, 0], */
					[ 'Jan', ${countOpdAdmissionJanuary}, ${countOpdDischargeJanuary}, ${countOpdDeathJanuary}], 
					[ 'Feb', ${countOpdAdmissionFebruary}, ${countOpdDischargeFebruary}, ${countOpdDeathFebruary} ],
					[ 'March', ${countOpdAdmissionMarch}, ${countOpdDischargeMarch}, ${countOpdDeathMarch} ], 
					[ 'April', ${countOpdAdmissionApril}, ${countOpdDischargeApril}, ${countOpdDeathApril} ],
					[ 'May', ${countOpdAdmissionMay}, ${countOpdDischargeMay}, ${countOpdDeathMay} ],
					[ 'June', ${countOpdAdmissionJune}, ${countOpdDischargeJune}, ${countOpdDeathJune} ],
					[ 'July', ${countOpdAdmissionJuly}, ${countOpdDischargeJuly}, ${countOpdDeathJuly} ],
					[ 'Aug', ${countOpdAdmissionAugust}, ${countOpdDischargeAugust}, ${countOpdDeathAugust} ],
					[ 'Sept', ${countOpdAdmissionSeptember}, ${countOpdDischargeSeptember}, ${countOpdDeathSeptember} ],
					[ 'Oct', ${countOpdAdmissionOctober}, ${countOpdDischargeOctober}, ${countOpdDeathOctober} ],
					[ 'Nov', ${countOpdAdmissionNovember}, ${countOpdDischargeNovember}, ${countOpdDeathNovember} ],
					[ 'Dec', ${countOpdAdmissionDecember}, ${countOpdDischargeDecember}, ${countOpdDeathDecember} ]]);
