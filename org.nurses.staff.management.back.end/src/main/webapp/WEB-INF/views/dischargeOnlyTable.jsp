...
<!--  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.7/css/bootstrap.min.css"> -->
	...
	<div >
				<ul class="b4">
					<h1 style="color: gold; font-weight: 900;">
						<span class="b5" style="color: white;">HS</span>MS
					</h1>
				</ul>
			</div>
			<div style="float: lef;">
 ...
 <h1>Discharge Table</h1>
    ...
    <!-- <div style="text-align: center; width: 100%;"> -->
       ...
       <div> </div> <br> <br>
        ...
        <button id="b2" style="float: left; border-radius: .5em; font-size:1em; margin-left: 2em;" class="btn btn-primary" onclick="window.print('table')" > <i id="b1" class="fa fa-print"></i> </button>
