...
<title>Children's Ward Home</title>
<meta charset="utf-8">
...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="navbar_top">
		<a class="navbar-brand" href="#"><h1
				...
				<span style="color: blue; font-size:;">P</span>CW
			</h1></a>
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/leaveFront/displayAllChildrensWardRecom">Recommend
						Leave</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/leaveFront/displayLeaveApprovalChildrensWard">Check
						Leave Approval</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/scheduleFront/displayAllCheckChildrensWardSchedule">Check
						Ward Schedule</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="modal"
...
<div class="dropdown">
				...
				<ul class="nav nav-pills flex-column">
					...
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/admissionFront/childrensWard">Admission</a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/admissionFront/displayDischargeOnlyChildrensWard">Discharge</a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/admissionFront/displayDeathChildrensWard">Death</a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/bedStateFront/displayAllChildrensWarWard_Bed_State">Ward
							State</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/admissionFront/displayAllAdmission_DischargeChildrensWard">Admission/Discharge</a>
					</li>
				</ul>
				</div>
...
<div class="nav-item nav nav-pills" >
		...
		<input type="text" value="Childrens Ward" name="wardName" hidden="true">
			...
			<div class="w3-container w3-padding w3-center"
				...
				<div class="row w3-padding " style="width:200%;">
					...
					<div class="w3-card-2 w3-yellow w3-margin"
						...
						<p style="text-align: left;">total Nurses: ${nurseInChildrensWard}</p>
						...
						<table width="200">
							...
							<tbody id="tbe">
								...
								try {
									...
									.prepareStatement("select nurse_cate, count(*) as number from ward_schedule where ward_name = 'Childrens Ward' group by nurse_cate;");
					...
					<div class="w3-card-2 w3-red w3-margin"
						...
						<p style="text-align: left;">total Admission:
							${countChildrensWardAdmissionToDate}</p>
						<p style="text-align: left;">total Discharge:
							${countChildrensWardDischarge}</p>
						<p style="text-align: left;">total Death: ${countChildrensWardDeath}</p>
					</div>
					<div class="w3-card-2 w3-teal w3-margin"
						...
						<p style="text-align: left;">Total Admission:
							${countChildrensWardTodayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countChildrensWardTodayDischarge}</p>
						<p style="text-align: left;">Total Death: ${countChildrensWardTodayDeath}</p>
					</div>
					...
					<div class="w3-card-2 w3-blue w3-margin"
						...
						<a class="w3-card-2 w3-blue w3-margin" style="" href="#"> <strong>
								...
								try {
									...
									PreparedStatement ps = conn
									.prepareStatement("select bed_capacity from ward where ward_name = 'Childrens Ward';");
								...
								try {
									...
									.prepareStatement("select count(*) as a from admission_discharge where year(date_admitted) = year(curdate())  and ward_name = 'Childrens Ward' and outcome_of_admission is null or outcome_of_admission='';"); 
					...
					<div class="w3-card-2 w3-teal w3-margin w3-round-large"
						...
						<p style="text-align: left;">Total Admission:
							${countChildrensWardYesterdayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countChildrensWardYesterdayDischarge}</p>
						<p style="text-align: left;">Total Death:
							${countChildrensWardYesterdayDeath}</p>
		...
		google.charts.setOnLoadCallback(drawChart);
		 ...
		 function drawChart() {
			var data = google.visualization.arrayToDataTable([
					...
					/* [0, 0, 0, 0], */
					[ 'Jan', ${countChildrensWardAdmissionJanuary}, ${countChildrensWardDischargeJanuary}, ${countChildrensWardDeathJanuary}], 
					[ 'Feb', ${countChildrensWardAdmissionFebruary}, ${countChildrensWardDischargeFebruary}, ${countChildrensWardDeathFebruary} ],
					[ 'March', ${countChildrensWardAdmissionMarch}, ${countChildrensWardDischargeMarch}, ${countChildrensWardDeathMarch} ], 
					[ 'April', ${countChildrensWardAdmissionApril}, ${countChildrensWardDischargeApril}, ${countChildrensWardDeathApril} ],
					[ 'May', ${countChildrensWardAdmissionMay}, ${countChildrensWardDischargeMay}, ${countChildrensWardDeathMay} ],
					[ 'June', ${countChildrensWardAdmissionJune}, ${countChildrensWardDischargeJune}, ${countChildrensWardDeathJune} ],
					[ 'July', ${countChildrensWardAdmissionJuly}, ${countChildrensWardDischargeJuly}, ${countChildrensWardDeathJuly} ],
					[ 'Aug', ${countChildrensWardAdmissionAugust}, ${countChildrensWardDischargeAugust}, ${countChildrensWardDeathAugust} ],
					[ 'Sept', ${countChildrensWardAdmissionSeptember}, ${countChildrensWardDischargeSeptember}, ${countChildrensWardDeathSeptember} ],
					[ 'Oct', ${countChildrensWardAdmissionOctober}, ${countChildrensWardDischargeOctober}, ${countChildrensWardDeathOctober} ],
					[ 'Nov', ${countChildrensWardAdmissionNovember}, ${countChildrensWardDischargeNovember}, ${countChildrensWardDeathNovember} ],
					[ 'Dec', ${countChildrensWardAdmissionDecember}, ${countChildrensWardDischargeDecember}, ${countChildrensWardDeathDecember} ]
