...
<title>Children's Ward Home Page</title>
<meta charset="utf-8">
					...
					<div class="w3-card-2 w3-blue w3-margin"
						...
						<a class="w3-card-2 w3-blue w3-margin" style="" href="#"> <strong>
								...
								try {
									...
									.prepareStatement("select count(*) as a from admission_discharge where year(date_admitted) = year(curdate())  and ward_name = ',Maternity' and outcome_of_admission is null or outcome_of_admission='';"); 
