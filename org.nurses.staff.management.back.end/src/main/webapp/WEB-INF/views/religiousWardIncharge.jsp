...
<title>Religious Ward Home</title>
<meta charset="utf-8">
...
<body>
	<div class="jumbotron text-center" style="margin-bottom: 0">
		<h1></h1> <h2>Religious/Special Ward</h2>
		<p></p>
	</div>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="navbar_top">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" data-toggle="modal" href='#modal-id'>
	...
	<div class="container" style="margin: 0px">
		<div class="row">
			<div class="col-sm-3 table-secondary" style="height:1000px;">
				<h2>Administrator</h2>
				<h5>Photo of me:</h5>
			...
			<div class="w3-container w3-padding w3-center"
				...
				<div class="row w3-padding " style="width:200%;">
					...
					<div class="w3-card-2 w3-yellow w3-margin"
						...
						<p style="text-align: left;">total Nurses: ${nurseInReligiousWard}</p>
						...
						<table width="200">
							...
							<tbody id="tbe">
								...
								try {
									...
									.prepareStatement("select nurse_cate, count(*) as number from ward_schedule where ward_name = 'Religious Ward' group by nurse_cate;");
					...
					<div class="w3-card-2 w3-red w3-margin"
						...
						<p style="text-align: left;">total Admission:
							${countReligiousWardAdmissionToDate}</p>
						<p style="text-align: left;">total Discharge:
							${countReligiousWardDischarge}</p>
						<p style="text-align: left;">total Death: ${countReligiousWardDeath}</p>
					</div>
					<div class="w3-card-2 w3-teal w3-margin"
						...
						<p style="text-align: left;">Total Admission:
							${countReligiousWardTodayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countReligiousWardTodayDischarge}</p>
						<p style="text-align: left;">Total Death: ${countReligiousWardTodayDeath}</p>
					</div>
					...
					<div class="w3-card-2 w3-blue w3-margin"
						...
						<a class="w3-card-2 w3-blue w3-margin" style="" href="#"> <strong>
								...
								try {
									...
									PreparedStatement ps = conn
									.prepareStatement("select bed_capacity from ward where ward_name = 'Religious Ward';");
								...
								try {
									...
									.prepareStatement("select count(*) as a from admission_discharge where year(date_admitted) = year(curdate())  and ward_name = 'Religious Ward' and outcome_of_admission is null or outcome_of_admission='';"); 
					...
					<div class="w3-card-2 w3-teal w3-margin w3-round-large"
						...
						<p style="text-align: left;">Total Admission:
							${countReligiousWardYesterdayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countReligiousWardYesterdayDischarge}</p>
						<p style="text-align: left;">Total Death:
							${countReligiousWardYesterdayDeath}</p>
				...
				<form
					...
					<div class="modal-body" id="modalBody">
						...
						<div class="thirdContainer">
							<div class="row" id="leaveThirdContainer">
								<div class="col">
									<div class="form-group">
								...
								<div class="col">
									<div class="form-group">
										...
										<!-- <input type="text"
											...
											<select class="form-control" name="ward_name" style="width: 60%;">
		...
		google.charts.setOnLoadCallback(drawChart);
		 ...
		 function drawChart() {
			var data = google.visualization.arrayToDataTable([
					...
					/* [0, 0, 0, 0], */
					[ 'Jan', ${countReligiousWardAdmissionJanuary}, ${countReligiousWardDischargeJanuary}, ${countDeathJanuary}], 
					[ 'Feb', ${countReligiousWardAdmissionFebruary}, ${countReligiousWardDischargeFebruary}, ${countReligiousWardDeathFebruary} ],
					[ 'March', ${countReligiousWardAdmissionMarch}, ${countReligiousWardDischargeMarch}, ${countReligiousWardDeathMarch} ], 
					[ 'April', ${countReligiousWardAdmissionApril}, ${countReligiousWardDischargeApril}, ${countReligiousWardDeathApril} ],
					[ 'May', ${countReligiousWardAdmissionMay}, ${countReligiousWardDischargeMay}, ${countReligiousWardDeathMay} ],
					[ 'June', ${countReligiousWardAdmissionJune}, ${countReligiousWardDischargeJune}, ${countReligiousWardDeathJune} ],
					[ 'July', ${countReligiousWardAdmissionJuly}, ${countReligiousWardDischargeJuly}, ${countReligiousWardDeathJuly} ],
					[ 'Aug', ${countReligiousWardAdmissionAugust}, ${countReligiousWardDischargeAugust}, ${countReligiousWardDeathAugust} ],
					[ 'Sept', ${countReligiousWardAdmissionSeptember}, ${countReligiousWardDischargeSeptember}, ${countReligiousWardDeathSeptember} ],
					[ 'Oct', ${countReligiousWardAdmissionOctober}, ${countReligiousWardDischargeOctober}, ${countReligiousWardDeathOctober} ],
					[ 'Nov', ${countReligiousWardAdmissionNovember}, ${countReligiousWardDischargeNovember}, ${countReligiousWardDeathNovember} ],
					[ 'Dec', ${countReligiousWardAdmissionDecember}, ${countReligiousWardDischargeDecember}, ${countReligiousWardDeathDecember} ]
