...
<select class  ="form-control" name="state" id="maxRows" style="width:20%; padding: .5em 2em; border-radius: 5em; display:flex; flex-direction: flex-end;">
        ...
        <table class="table table-bordered table-hover" style="background-color: antiquewhite; width:100" id="name">
            ...
            <c:forEach items="${admissionOnly}" var="admissionOnly">
            
            
            <c:url value="deleteAdmission_Discharge/${admissionOnly.id}" var="delete">
            
            
            </c:url>
            
            
            <c:url value="updateAdmission_Discharge1/${admissionOnly.id}"  var="update">
                ...
                <tr>
                    ...
                    <td>${admissionOnly.id}</td>
                    <td>${admissionOnly.ward_name}</td>
                    <td>${admissionOnly.patient_number}</td>
                    <td>${admissionOnly.patient_name}</td>
                    <td>${admissionOnly.sex}</td>
                   
                    <td>${admissionOnly.date_admitted}</td>
                    <td>${admissionOnly.diagnosis}</td>
