...
<title>Accident and Emergency Home</title>
<meta charset="utf-8">
			...
			<div class="w3-container w3-padding w3-center"
				...
				<div class="row w3-padding " style="width:200%;">
					...
					<div class="w3-card-2 w3-yellow w3-margin"
						...
						<p style="text-align: left;">total Nurses: ${nurseInAccidentEmergency}</p>
						...
						<table width="200">
							...
							<tbody id="tbe">
								...
								try {
									...
									.prepareStatement("select nurse_cate, count(*) as number from ward_schedule where ward_name = 'Accident/Emergency' group by nurse_cate;");
					...
					<div class="w3-card-2 w3-red w3-margin"
						...
						<p style="text-align: left;">total Admission:
							${countAccidentEmergencyAdmissionToDate}</p>
						<p style="text-align: left;">total Discharge:
							${countAccidentEmergencyDischarge}</p>
						<p style="text-align: left;">total Death: ${countAccidentEmergencyDeath}</p>
					</div>
					<div class="w3-card-2 w3-teal w3-margin"
						...
						<p style="text-align: left;">Total Admission:
							${countAccidentEmergencyTodayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countAccidentEmergencyTodayDischarge}</p>
						<p style="text-align: left;">Total Death: ${countAccidentEmergencyTodayDeath}</p>
					</div>
					...
					<div class="w3-card-2 w3-blue w3-margin"
						...
						<a class="w3-card-2 w3-blue w3-margin" style="" href="#"> <strong>
								...
								try {
									...
									PreparedStatement ps = conn
									.prepareStatement("select bed_capacity from ward where ward_name = 'Accident/Emergency';");
								...
								try {
									...
									.prepareStatement("select count(*) as a from admission_discharge where year(date_admitted) = year(curdate())  and ward_name = 'Accident/Emergency' and outcome_of_admission is null or outcome_of_admission='';"); 
					...
					<div class="w3-card-2 w3-teal w3-margin w3-round-large"
						...
						<p style="text-align: left;">Total Admission:
							${countAccidentEmergencyYesterdayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countAccidentEmergencyYesterdayDischarge}</p>
						<p style="text-align: left;">Total Death:
							${countAccidentEmergencyYesterdayDeath}</p>
	...
	<script type="text/javascript">
		...
		function drawChart() {
			var data = google.visualization.arrayToDataTable([
					...
					[ 'Year', 'Admission', 'Discharge', 'Death' ],
					/* [0, 0, 0, 0], */
					[ 'Jan', ${countAccidentEmergencyAdmissionJanuary}, ${countAccidentEmergencyDischargeJanuary}, ${countAccidentEmergencyDeathJanuary}], 
					[ 'Feb', ${countAccidentEmergencyAdmissionFebruary}, ${countAccidentEmergencyDischargeFebruary}, ${countAccidentEmergencyDeathFebruary} ],
					[ 'March', ${countAccidentEmergencyAdmissionMarch}, ${countAccidentEmergencyDischargeMarch}, ${countAccidentEmergencyDeathMarch} ], 
					[ 'April', ${countAccidentEmergencyAdmissionApril}, ${countAccidentEmergencyDischargeApril}, ${countAccidentEmergencyDeathApril} ],
					[ 'May', ${countAccidentEmergencyAdmissionMay}, ${countAccidentEmergencyDischargeMay}, ${countAccidentEmergencyDeathMay} ],
					[ 'June', ${countAccidentEmergencyAdmissionJune}, ${countAccidentEmergencyDischargeJune}, ${countAccidentEmergencyDeathJune} ],
					[ 'July', ${countAccidentEmergencyAdmissionJuly}, ${countAccidentEmergencyDischargeJuly}, ${countAccidentEmergencyDeathJuly} ],
					[ 'Aug', ${countAccidentEmergencyAdmissionAugust}, ${countAccidentEmergencyDischargeAugust}, ${countAccidentEmergencyDeathAugust} ],
					[ 'Sept', ${countAccidentEmergencyAdmissionSeptember}, ${countAccidentEmergencyDischargeSeptember}, ${countAccidentEmergencyDeathSeptember} ],
					[ 'Oct', ${countAccidentEmergencyAdmissionOctober}, ${countAccidentEmergencyDischargeOctober}, ${countAccidentEmergencyDeathOctober} ],
					[ 'Nov', ${countAccidentEmergencyAdmissionNovember}, ${countAccidentEmergencyDischargeNovember}, ${countAccidentEmergencyDeathNovember} ],
					[ 'Dec', ${countAccidentEmergencyAdmissionDecember}, ${countAccidentEmergencyDischargeDecember}, ${countAccidentEmergencyDeathDecember} ]]);
