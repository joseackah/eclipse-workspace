...
<hr class="d-sm">
   ...
   <main style="width: 100%;">
    <div style="text-align: center; width: 100%; margin:2px  2em;">
<h1 > </h1>
 <h1>Users Table</h1>
  </div>
...
<!-- <div  style=" display:flex; flex-direction:row-reverse;"> <input class="form-control" id="myInput" type="text" placeholder="Search.." style="padding: .5em 2em; border-radius: 5em; width:20%; display:flex; flex-direction: flex-end;"> </div>
 -->       
<div style=" display:flex; flex-direction:row-reverse;">    <button onclick="window.location.href='${pageContext.request.contextPath}/nurseFront/addStaff'" class="btn btn-primary" id="myInput" type="button"  style="padding: .5em 2em; border-radius: 5em; width:20%; display:; flex-direction: flex-end;">Add User </button>
 ...
 <select class  ="form-control" name="state" id="maxRows" style="width:20%; padding: .5em 2em; border-radius: 5em; display:flex; flex-direction: flex-end;">
        ...
        <table class="table table-bordered table-hover" style="background-color: aliceblue;" id="name">
            ...
            <c:url value="deleteUser/${userT.id}" var="delete">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            window.addEventListener('scroll', function() {
                if (window.scrollY > 50) {
                    document.getElementById('navbar_to').classList.add('fixed-top');
                    // add padding top to show content behind navbar
                    navbar_height = document.querySelector('.navbar').offsetHeight;
                    document.body.style.paddingTop = navbar_height + 'px';
                } else {
                    document.getElementById('navbar_to').classList.remove('fixed-top');
