 ...
 <input type="text" class="form-control" name="id" id="" value="${admission.id }" hidden="true">
                            ...
                            <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="age" class="form-control" value="${admission.age}">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col" id="finalDiagnosis" style="display:none;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="final_diagnosis" id="" disabled>
                                    </div>
                                </div>
                                <div class="col" >
                                    <div class="form-group" >
                             ...
                             <div class="row">
                                <div class="col" id="dateDischarge" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date_discharge" id="" disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="submit" class="btn btn-primary"  onclick="confirm()">Save Record</button>
                    </div>
                </form>
            </div>
        </div>
...
function comfirm(){
	...
	var com = document.getElementById("submit");
	
	confirm("Do you want to update this record?");
