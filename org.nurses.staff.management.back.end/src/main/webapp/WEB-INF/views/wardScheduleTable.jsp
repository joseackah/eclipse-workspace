...
<!-- <div style=" display:flex; flex-direction:row-reverse;"> <input class="form-control" id="myInput" type="text" placeholder="Search.." style="padding: .5em 2em; border-radius: 5em; width:20%; display:flex; flex-direction: flex-end;"> </div>
 -->        
        ...
        <div style=" display:flex; flex-direction:row-reverse;">    <button onclick="window.location.href='${pageContext.request.contextPath}/nurseFront/addStaff'" class="btn btn-primary" id="myInput" type="button"  style="padding: .5em 2em; border-radius: 5em; width:20%; display:; flex-direction: flex-end;">Schedule Staff </button>
 ...
 <select class  ="form-control" name="state" id="maxRows" style="width:20%; padding: .5em 2em; border-radius: 5em; display:flex; flex-direction: flex-end;">
        ...
        <table class="table table-bordered table-hover" style="background-color: beige;" id="name">
            ...
            <c:forEach items="${scheduleTable}" var="scheduleTable">
                        ...
                        <c:url value="deleteSchedule/${scheduleTable.id}" var="delete">
            
            
            </c:url>
            
            
            <c:url value="updateSchedule1/${scheduleTable.id}"  var="update">
            
					<%-- <c:param value="${scheduleTable.id}" name="id"></c:param> --%>
