...
<title>Male Surgical Home</title>
<meta charset="utf-8">
...
<div class="nav-item nav nav-pills" >
			...
			<div class="w3-container w3-padding w3-center"
				...
				<div class="row w3-padding " style="width:200%;">
					...
					<div class="w3-card-2 w3-yellow w3-margin"
						...
						<p style="text-align: left;">total Nurses: ${nurseInMaleSurgical}</p>
						...
						<table width="200">
							...
							<tbody id="tbe">
								...
								try {
									...
									.prepareStatement("select nurse_cate, count(*) as number from ward_schedule where ward_name = 'Male Surgical' group by nurse_cate;");
					...
					<div class="w3-card-2 w3-red w3-margin"
						...
						<p style="text-align: left;">total Admission:
							${countMaleSurgicalAdmissionToDate}</p>
						<p style="text-align: left;">total Discharge:
							${countMaleSurgicalDischarge}</p>
						<p style="text-align: left;">total Death: ${countMaleSurgicalDeath}</p>
					</div>
					<div class="w3-card-2 w3-teal w3-margin"
						...
						<p style="text-align: left;">Total Admission:
							${countMaleSurgicalTodayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countMaleSurgicalTodayDischarge}</p>
						<p style="text-align: left;">Total Death: ${countMaleSurgicalTodayDeath}</p>
					</div>
					...
					<div class="w3-card-2 w3-blue w3-margin"
						...
						<a class="w3-card-2 w3-blue w3-margin" style="" href="#"> <strong>
								...
								try {
									...
									PreparedStatement ps = conn
									.prepareStatement("select bed_capacity from ward where ward_name = 'Male Surgical';");
								...
								try {
									...
									.prepareStatement("select count(*) as a from admission_discharge where year(date_admitted) = year(curdate())  and ward_name = 'male surgical' and outcome_of_admission is null or outcome_of_admission='';"); 
					...
					<div class="w3-card-2 w3-teal w3-margin w3-round-large"
						...
						<p style="text-align: left;">Total Admission:
							${countMaleSurgicalYesterdayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countMaleSurgicalYesterdayDischarge}</p>
						<p style="text-align: left;">Total Death:
							${countMaleSurgicalYesterdayDeath}</p>
	...
	<!-- <a class="btn btn-primary" data-toggle="modal" href='#modal-id1'>Trigger
		modal</a> --><div class="modal fade" id="modal-id4">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="modalHeader">
	...
	<script type="text/javascript">
		...
		function drawChart() {
			var data = google.visualization.arrayToDataTable([
					...
					[ 'Year', 'Admission', 'Discharge', 'Death' ],
					/* [0, 0, 0, 0], */
					[ 'Jan', ${countMaleSurgicalAdmissionJanuary}, ${countMaleSurgicalDischargeJanuary}, ${countMaleSurgicalDeathJanuary}], 
					[ 'Feb', ${countMaleSurgicalAdmissionFebruary}, ${countMaleSurgicalDischargeFebruary}, ${countMaleSurgicalDeathFebruary} ],
					[ 'March', ${countMaleSurgicalAdmissionMarch}, ${countMaleSurgicalDischargeMarch}, ${countMaleSurgicalDeathMarch} ], 
					[ 'April', ${countMaleSurgicalAdmissionApril}, ${countMaleSurgicalDischargeApril}, ${countMaleSurgicalDeathApril} ],
					[ 'May', ${countMaleSurgicalAdmissionMay}, ${countMaleSurgicalDischargeMay}, ${countMaleSurgicalDeathMay} ],
					[ 'June', ${countMaleSurgicalAdmissionJune}, ${countMaleSurgicalDischargeJune}, ${countMaleSurgicalDeathJune} ],
					[ 'July', ${countMaleSurgicalAdmissionJuly}, ${countMaleSurgicalDischargeJuly}, ${countMaleSurgicalDeathJuly} ],
					[ 'Aug', ${countMaleSurgicalAdmissionAugust}, ${countMaleSurgicalDischargeAugust}, ${countMaleSurgicalDeathAugust} ],
					[ 'Sept', ${countMaleSurgicalAdmissionSeptember}, ${countMaleSurgicalDischargeSeptember}, ${countMaleSurgicalDeathSeptember} ],
					[ 'Oct', ${countMaleSurgicalAdmissionOctober}, ${countMaleSurgicalDischargeOctober}, ${countMaleSurgicalDeathOctober} ],
					[ 'Nov', ${countMaleSurgicalAdmissionNovember}, ${countMaleSurgicalDischargeNovember}, ${countMaleSurgicalDeathNovember} ],
					[ 'Dec', ${countMaleSurgicalAdmissionDecember}, ${countMaleSurgicalDischargeDecember}, ${countMaleSurgicalDeathDecember} ]]);
