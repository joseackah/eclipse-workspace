...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="navbar_top">
		<a class="navbar-brand" href="#"><h1
				...
				<span style="color: blue; font-size:;">G</span>W
			</h1></a>
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/leaveFront/displayAllGeneralWardRecom">Recommend
						Leave</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/leaveFront/displayLeaveApprovalGeneralWard">Check
						Leave Approval</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/scheduleFront/displayAllCheckGeneralWardSchedule">Check
						Ward Schedule</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="modal"
...
<div class="dropdown">
				...
				<ul class="nav nav-pills flex-column">
					...
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/admissionFront/generalWard">Admission</a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/admissionFront/displayDischargeOnlyGeneralWard">Discharge</a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/admissionFront/displayDeathGeneralWard">Death</a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/bedStateFront/displayAllGeneralWardWard_Bed_State">Ward
							State</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/admissionFront/displayAllAdmission_DischargeGeneralWard">Admission/Discharge</a>
					</li>
				</ul>
				</div>
...
<div class="nav-item nav nav-pills" >
		...
		<input type="text" value="General Ward" name="wardName" hidden="true">
			...
			<div class="w3-container w3-padding w3-center"
				...
				<div class="row w3-padding " style="width:200%;">
					...
					<div class="w3-card-2 w3-yellow w3-margin"
						...
						<p style="text-align: left;">total Nurses: ${nurseInGeneralWard}</p>
						...
						<table width="200">
							...
							<tbody id="tbe">
								...
								try {
									...
									.prepareStatement("select nurse_cate, count(*) as number from ward_schedule where ward_name = 'General Ward' group by nurse_cate;");
					...
					<div class="w3-card-2 w3-red w3-margin"
						...
						<p style="text-align: left;">total Admission:
							${countGeneralWardAdmissionToDate}</p>
						<p style="text-align: left;">total Discharge:
							${countGeneralWardDischarge}</p>
						<p style="text-align: left;">total Death: ${countGeneralWardDeath}</p>
					</div>
					<div class="w3-card-2 w3-teal w3-margin"
						...
						<p style="text-align: left;">Total Admission:
							${countGeneralWardTodayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countGeneralWardTodayDischarge}</p>
						<p style="text-align: left;">Total Death: ${countGeneralWardTodayDeath}</p>
					</div>
					...
					<div class="w3-card-2 w3-blue w3-margin"
						...
						<a class="w3-card-2 w3-blue w3-margin" style="" href="#"> <strong>
								...
								try {
									...
									PreparedStatement ps = conn
									.prepareStatement("select bed_capacity from ward where ward_name = 'General Ward';");
								...
								try {
									...
									.prepareStatement("select count(*) as a from admission_discharge where year(date_admitted) = year(curdate())  and ward_name = 'general Ward' and outcome_of_admission is null or outcome_of_admission='';"); 
					...
					<div class="w3-card-2 w3-teal w3-margin w3-round-large"
						...
						<p style="text-align: left;">Total Admission:
							${countGeneralWardYesterdayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countGeneralWardYesterdayDischarge}</p>
						<p style="text-align: left;">Total Death:
							${countGeneralWardYesterdayDeath}</p>
		...
		google.charts.setOnLoadCallback(drawChart);
		 ...
		 function drawChart() {
			var data = google.visualization.arrayToDataTable([
					...
					/* [0, 0, 0, 0], */
					[ 'Jan', ${countGeneralWardAdmissionJanuary}, ${countGeneralWardDischargeJanuary}, ${countGeneralWardDeathJanuary}], 
					[ 'Feb', ${countGeneralWardAdmissionFebruary}, ${countGeneralWardDischargeFebruary}, ${countGeneralWardDeathFebruary} ],
					[ 'March', ${countGeneralWardAdmissionMarch}, ${countGeneralWardDischargeMarch}, ${countGeneralWardDeathMarch} ], 
					[ 'April', ${countGeneralWardAdmissionApril}, ${countGeneralWardDischargeApril}, ${countGeneralWardDeathApril} ],
					[ 'May', ${countGeneralWardAdmissionMay}, ${countGeneralWardDischargeMay}, ${countGeneralWardDeathMay} ],
					[ 'June', ${countGeneralWardAdmissionJune}, ${countGeneralWardDischargeJune}, ${countGeneralWardDeathJune} ],
					[ 'July', ${countGeneralWardAdmissionJuly}, ${countGeneralWardDischargeJuly}, ${countGeneralWardDeathJuly} ],
					[ 'Aug', ${countGeneralWardAdmissionAugust}, ${countGeneralWardDischargeAugust}, ${countGeneralWardDeathAugust} ],
					[ 'Sept', ${countGeneralWardAdmissionSeptember}, ${countGeneralWardDischargeSeptember}, ${countGeneralWardDeathSeptember} ],
					[ 'Oct', ${countGeneralWardAdmissionOctober}, ${countGeneralWardDischargeOctober}, ${countGeneralWardDeathOctober} ],
					[ 'Nov', ${countGeneralWardAdmissionNovember}, ${countGeneralWardDischargeNovember}, ${countGeneralWardDeathNovember} ],
					[ 'Dec', ${countGeneralWardAdmissionDecember}, ${countGeneralWardDischargeDecember}, ${countGeneralWardDeathDecember} ]
