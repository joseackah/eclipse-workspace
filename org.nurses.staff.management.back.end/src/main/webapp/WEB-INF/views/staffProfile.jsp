...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark"
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/leaveFront/displayAllRecom">Recommend
						Leave</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/leaveFront/displayLeaveApproval">Check
						Leave Approval</a></li>
				<li class="nav-item"><a class="nav-link"
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/leaveFront/displayAllMaleMedicalLeave">leave
						check</a></li>
			</ul>
		</div>
		<button id="b1"
	...
	<div class="container" style="margin: 30px; width:90%;">
		<div class="row">
			<div class="col-sm-4" style="overflow-x:visible;">
				<h2>Administrator</h2>
				<h5>Photo of me:</h5>
				...
				<div class="dropdown">
					<div class="nav-item nav nav-pills flex-colmn">
						<div class="nav-link active">Ward Profiles</div>
					</div>
					<div class="dropdown-content">
...
<div class="col-xl" style="width:200%; margin:30px;">
			...
			<div class="w3-container w3-padding w3-center"
				...
				<div class="row w3-padding " style="width: 150%">
					...
					<div class="w3-card-2 w3-teal w3-margin"
						...
						<p style="text-align: left;">Total Admission:
							${countTodayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countTodayDischarge}</p>
					...
					<div class="w3-card-2 w3-teal w3-margin w3-round-large"
						...
						<p style="text-align: left;">Total Admission:
							${countYesterdayAdmission}</p>
						<p style="text-align: left;">Total Discharge:
							${countYesterdayDischarge}</p>
						<p style="text-align: left;">Total Death:
							${countYesterdayDeath}</p>
			...
			<div class="col-sm-8">
				...
				<div class="fakeim" style="width: 100%;">
	...
	<div class="modal fade" id="modal-id2" ng-app="">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form
					action="${pageContext.request.contextPath}/bedStateFront/saveWard_Bed_State">
					<div class="modal-body">
								...
								<div class="col">
									<div class="form-group">
										<label for="total_admission">Total Admission</label> <input
											type="number" ng-model="tAdmission" class="form-control"
											name="total_admission" id="tAdmission">
								...
								<div class="col">
									<div class="form-group">
										<label for="total_discharge">Total Discharge</label> <input
											type="number" class="form-control" ng-model="tDischarge"
											name="total_discharge" id="tDischarge">
									</div>
								</div>
							</div>
						...
						<div class="secondContainer">
								...
								<div class="col">
									<div class="form-group">
										<label for="total_trans_in">Total Trans In</label> <input
											type="number" class="form-control" ng-model="transin"
								...
								<div class="col">
									<div class="form-group">
										<label for="total_trans_out">Total Trans Out</label> <input
											type="number" class="form-control" ng-model="transout"
							...
							<div class="row">
								<div class="col">
									<div class="form-group">
										<label for="total_deaths">Total Death</label> <input
											type="number" class="form-control" ng-model="death"
											name="total_deaths" id="">
								...
								<div class="col">
									<div class="form-group">
										<label for="total_absconded">Abscond</label> <input
											type="number" class="form-control" ng-model="abscond"
							...
							<div class="row">
								...
								<div class="col" id="insurance_number">
									...
									<div class="form-group" id="dis">
										<label for="total_remain_at_midnight">Total Remained
											At Midnight</label> <input type="number"
											name="total_remain_at_midnight"
											value="{{(tAdmission+transin)-(tDischarge+death+transout+abscond)}}"
											class="form-control" min="0"
											onKeyPress="if(this.value.length==10) return false;">
									</div>
								</div>
									...
									.addEventListener(
											...
											function() {
												if (window.scrollY > 50) {
													document
															.getElementById('navbar_top').classList
															.add('fixed-top');
													// add padding top to show content behind navbar
													navbar_height = document
															.querySelector('.navbar').offsetHeight;
