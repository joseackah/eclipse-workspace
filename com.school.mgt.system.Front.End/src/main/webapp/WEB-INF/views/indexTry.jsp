    ...
    <nav>
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/general/homeExample">HOME Example</a></li>
       		<li><a href="${pageContext.request.contextPath}/general/adminPageExample">Admin Page Example</a></li>
        <li><a href="${pageContext.request.contextPath}/general/image">register</a></li>
        <li><a href="${pageContext.request.contextPath}/general/adminHomePageExample2">Admin Home</a></li>
        </ul>
