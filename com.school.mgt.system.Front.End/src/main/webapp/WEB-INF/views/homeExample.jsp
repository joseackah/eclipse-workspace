...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" style="color:black;">
    <ul class="navbar-nav" style="background-color:; ">
      <li class="nav-item" style="background-color:blue;">
        <a class="nav-link" href="${pageContext.request.contextPath}/general/logIn">Home</a>
      </li> 
      <li class="nav-item" style="background-color:blue;">
        <a class="nav-link" href="${pageContext.request.contextPath}/general/teacherLogin">enrol student</a>
      </li> 
      <li class="nav-item" style="background-color:blue;">
        <a class="nav-link" href="${pageContext.request.contextPath}/general/parentLogin">add parent</a>
      </li> 
      <li class="nav-item" style="background-color:blue;">
        <a class="nav-link" href="${pageContext.request.contextPath}/schoolStudents/studentsForm">Display student</a>
      </li> 
      <li class="nav-item" style="background-color:blue;"><a class="nav-link" href="${pageContext.request.contextPath}/studentAddress/displayStudentAddress">Student Address</a></li>
      <li class="nav-item" style="background-color:blue;"><a class="nav-link" href="${pageContext.request.contextPath}/schoolStudents/showStudentsForm">Add Teacher</a></li>
      <li class="nav-item" style="background-color:blue;"><a class="nav-link" href="${pageContext.request.contextPath}/schoolTeachers/displayTeachers">All Teachers</a></li>
      <li class="nav-item" style="background-color:blue;"><a class="nav-link" href="${pageContext.request.contextPath}/general/lowerResults">getLowerResults</a></li>
 ...
 <div id='firstHeader' class='firstHeader' name='firstHeader'>
    ...
    <nav style="align-content:center; justify:center;" class="navbar navbar-expand-lg bg-dark navbar-dark">
   <div style="display: flex;">
    <div> <ul> <li> <h1 style="color:gold; font-weight: 900;"><span style="color:blue;">BI</span>PS</h1> </li> </ul></div>
     <div>
     <button style="position: relative; right:-35em; top:2em;" class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNav">
    <span  class="navbar-toggler-icon" ></span>
  </button>
     
     <div class="collapse navbar-collapse" id="collapsibleNav">
     <ul style="align-content:center; justify:center; display:inline-block;">
