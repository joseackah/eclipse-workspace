...
public class PrimaryThreeResultsTerm3 {
	...
	public void setSubjecst(String subjects) {
		this.subjects = subjects;
	}
	...
	public String toString() {
		return "PrimaryThreeResultsTerm3 [results_id=" + results_id + ", student_id=" + student_id + ", first_name="
