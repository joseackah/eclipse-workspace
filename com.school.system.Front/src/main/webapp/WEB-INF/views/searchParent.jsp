...
<div class= "wrapper">
<form:form action="display" method="post" modelAttribute = "parent">
<h2>Parent id retrieval</h2>
<div class="form"> Parent Id: <form:input path="parentId" value="${parent.parentId }" /></div>
