...
public class Leave {
	...
	public Leave(Integer id, String staff_id, String name, String staff_cate, String leave_type, Integer leave_day_earn,
			Integer leave_days_apply, String leave_date, String incharge_recom, String incharge_name,
			String leave_end_date, String resumption_date, String date_approved, String approved_by, String remarks, String ward_name) {
		super();
		this.id = id;
