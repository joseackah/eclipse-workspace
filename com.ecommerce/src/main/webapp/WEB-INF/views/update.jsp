...
<hr/>
	...
	<form action="updateUsers" method="post">
		User Id: <input type="text" name="id"
			value="${users.id}" readonly /><br /> First Name: <input
			type="text" name="firstName" value="${users.firstName}" /><br />
		Last Name:<input type="text" name="lastName"
			value="${users.lastName}" /><br /> User Name: <input
			type="text" name="userName" value="${users.userName}" /><br />
			Email: <input
			type="text" name="email" value="${users.email}" /><br />

		<input type="submit" value="update" />
	</form>
	<a href="deleteProduct/${users.id}"> Delete</a>
	${usersTable}
</body>
</html>