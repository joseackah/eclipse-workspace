...
<form action="saveProduct" method="post" id="main_form" class="main_form">
<div class="form">Product Id: <input type="text" name="id" placeholder="Product Id" required="required"/></div> 
<div class="form">Product Name: <input type="text" name="name" placeholder="Product Name" /></div>
<div class="form">Product Description: <input type="text" name="desc" placeholder="Product Description" /></div>
<div class="form">Product Price: <input type="text" name="price" placeholder="Product Price" required="required"/></div>

<div class="form">Product Category: 
<select class="form" form="addProduct">
<option class="form">Computers </option>
<option class="form">Fridges </option>
<option class="form">Television </option>
<option class="form">Furniture</option>
