/*
 * package com.ecommerce.front.END.security;
 * 
 ...
 * Exception {
 * 
 * auth.inMemoryAuthentication() .withUser("solo") .password("solo")
 * .roles("USER") .and() .withUser("kwame") .password("kwame") .roles("ADMIN");
 * 
 * 
 * }
 * 
